...
function BookingForm() {
    ...
    async function handleSubmit(e) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("bookings").insert({
            name: name.trim(),
            phone: phone.trim(),
            check_in: checkIn,
            check_out: checkOut,
...
//# sourceMappingURL=_0us_dks._.js.map